...
public class dez_numeros_pares_em {
    /*Crie um programa que determine o mostre os 10 primeiros números pares, considerando
números maiores que 0.  */
public static void main(String[] args) {
    Scanner parUmu = new Scanner(System.in);
    System.out.print("Informe qualquer número para ver os pares: ");
    int entrada = parUmu.nextInt(); 
    int contador = 0;
    int numero = 1;
    System.out.println("Os cinco primeiros números pares maiores que 0 em algarismos Neroanos são:");
